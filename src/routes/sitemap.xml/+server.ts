...
export const GET: RequestHandler = async ({ setHeaders }) => {
  ...
  try {
    ...
    const staticPages = [
      ...
      // Country-specific category pages (dynamic routes)
      { url: '/sweden/politics', priority: '0.85', changefreq: 'daily' },
      { url: '/sweden/business', priority: '0.85', changefreq: 'daily' },
      { url: '/sweden/tech', priority: '0.85', changefreq: 'daily' },
      { url: '/sweden/society', priority: '0.85', changefreq: 'daily' },
      { url: '/norway/politics', priority: '0.85', changefreq: 'daily' },
      { url: '/norway/business', priority: '0.85', changefreq: 'daily' },
      { url: '/norway/tech', priority: '0.85', changefreq: 'daily' },
      { url: '/norway/society', priority: '0.85', changefreq: 'daily' },
      { url: '/denmark/politics', priority: '0.85', changefreq: 'daily' },
      { url: '/denmark/business', priority: '0.85', changefreq: 'daily' },
      { url: '/denmark/tech', priority: '0.85', changefreq: 'daily' },
      { url: '/denmark/society', priority: '0.85', changefreq: 'daily' },
      { url: '/finland/politics', priority: '0.85', changefreq: 'daily' },
      { url: '/finland/business', priority: '0.85', changefreq: 'daily' },
      { url: '/finland/tech', priority: '0.85', changefreq: 'daily' },
      { url: '/finland/society', priority: '0.85', changefreq: 'daily' },
      { url: '/iceland/politics', priority: '0.85', changefreq: 'daily' },
      { url: '/iceland/business', priority: '0.85', changefreq: 'daily' },
      { url: '/iceland/tech', priority: '0.85', changefreq: 'daily' },
      { url: '/iceland/society', priority: '0.85', changefreq: 'daily' },
      // Other pages
